...
class LCMScheduler(SchedulerMixin, ConfigMixin):
    ...
    # ) -> Union[LCMSchedulerOutput, Tuple]:
    #     """
    #     Reverse the diffusion process to predict the next timestep sample in the inversion chain.
    #
    #     Args:
    #         model_output (`torch.Tensor`):
    #             The direct output from learned diffusion model.
    ...
    #             A current instance of a sample created by the diffusion process.
    #         noise (`torch.Tensor`):
    #             The noise tensor generated in the forward process, reused for inversion.
    #         return_dict (`bool`, *optional*, defaults to `True`):
    #             Whether or not to return a [`~schedulers.scheduling_lcm.LCMSchedulerOutput`] or `tuple`.
    #     Returns:
    #         [`~schedulers.scheduling_utils.LCMSchedulerOutput`] or `tuple`:
    ...
    #         noise = noise * beta_prod_t_prev.sqrt()
    #     else:
    ...
    #         return prev_sample
    #
    #     return LCMSchedulerOutput(prev_sample=prev_sample)
