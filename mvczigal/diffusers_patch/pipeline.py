    ...
    def __call__(
        ...
        **kwargs,
        ...
        if not output_type == "latent":
            ...
            needs_downcasting = self.vae.dtype == torch.float16 and not self.vae.config.force_upcast

            if needs_upcasting:
                self.upcast_vae()
                latents = latents.to(next(iter(self.vae.post_quant_conv.parameters())).dtype)
            elif needs_downcasting:
        ...
        return {
            ...
            # "negative_prompt_embeds": negative_prompt_embeds_ret,
            # "add_text_embeds": add_text_embeds_ret,
            # "negative_pooled_prompt_embeds": negative_pooled_prompt_embeds_ret,
